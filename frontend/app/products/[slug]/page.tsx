      ...
      >
        <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
          ...
          >
            ...
            >
              ...
              <span className="font-semibold text-primary-700">Premium Quality</span>
            </motion.div>
          ...
          >
            ...
            >
              <span className="text-sm font-semibold text-primary-700">Premium Product</span>
            </motion.div>
            ...
            >
              ...
              <p className="text-sm text-gray-600 mt-3">
                Competitive bulk rates available • Quality assured
              </p>
            </motion.div>
        ...
        >
          ...
          <p className="text-xl text-primary-100 mb-8 max-w-2xl mx-auto">
            Get in touch with us for competitive pricing and reliable supply
          </p>
          <Link href="/enquiry">
            <motion.div
